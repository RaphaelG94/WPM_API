...
namespace WPM_API.Controllers.Releas_Mgmt
{
    ...
    {
        public DriverController(AppSettings appSettings, ConnectionStrings connectionStrings, OrderEmailOptions orderEmailOptions, AgentEmailOptions agentEmailOptions, SendMailCreds sendMailCreds, SiteOptions siteOptions, ILogonManager logonManager) : base(appSettings, connectionStrings, orderEmailOptions, agentEmailOptions, sendMailCreds, siteOptions, logonManager)
        {
        }
        ...
        public IActionResult EditDriver([FromBody] DriverViewModel data)
        {
            ...
            var json = JsonConvert.SerializeObject(Mapper.Map<DriverViewModel>(toEdit), serializerSettings);
            return Ok(json);
        }
