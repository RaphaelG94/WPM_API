...
ALTER TABLE [Parameter] ADD [ClientOptionId] nvarchar(450) NULL;

GO

CREATE INDEX [IX_Parameter_ClientOptionId] ON [Parameter] ([ClientOptionId]);

GO

ALTER TABLE [Parameter] ADD CONSTRAINT [FK_Parameter_ClientOption_ClientOptionId] FOREIGN KEY ([ClientOptionId]) REFERENCES [ClientOption] ([PK_ClientOption]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190130101141_47_AddParameterToDeviceOptions', N'2.1.4-rtm-31024');
...
ALTER TABLE [Parameter] ADD [Description] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190226104620_55_AddDescriptionToParameter', N'2.1.4-rtm-31024');
