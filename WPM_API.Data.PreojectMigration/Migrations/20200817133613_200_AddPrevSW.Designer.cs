...
namespace WPM_API.Data.ProjectMigration.Migrations
{
    ...
    [Migration("20200817133613_200_AddPrevSW")]
    partial class _200_AddPrevSW
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Software", b =>
                {
                    ...
                    b.Property<string>("PreviousSoftwareId");
                    ...
                    b.HasIndex("NextSoftwareId")
                        .IsUnique()
                        .HasFilter("[NextSoftwareId] IS NOT NULL");

                    b.HasIndex("PreviousSoftwareId");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Software", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.Software", "NextSoftware")
                        .WithOne()
                        .HasForeignKey("Bitstream.Data.DataContext.Entities.Software", "NextSoftwareId");

                    b.HasOne("Bitstream.Data.DataContext.Entities.Software", "PreviousSoftware")
                        .WithMany()
                        .HasForeignKey("PreviousSoftwareId");
