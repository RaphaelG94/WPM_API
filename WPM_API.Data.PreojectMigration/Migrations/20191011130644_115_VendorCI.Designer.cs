...
namespace WPM_API.Data.ProjectMigration.Migrations
{
    ...
    [Migration("20191011130644_115_VendorCI")]
    partial class _115_VendorCI
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.AssetMgmt.AssetModel", b =>
                {
                    ...
                    b.Property<int>("DepreciationEnd");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Client", b =>
                {
                    ...
                    b.HasIndex("AssetModelId")
                        .IsUnique()
                        .HasFilter("[AssetModelId] IS NOT NULL");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.SmbStorage", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("DataDriveLetter");

                    b.Property<string>("DeletedByUserId");

                    b.Property<DateTime?>("DeletedDate");

                    b.Property<bool>("ExistedAlready");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.ValueWrapper", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("PK_ValiueWrapper");
                    ...
                    b.ToTable("ValueWrapper");
                });

            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.VendorCI", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Client", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.AssetMgmt.AssetModel", "AssetModel")
                        .WithOne("Client")
                        .HasForeignKey("Bitstream.Data.DataContext.Entities.Client", "AssetModelId");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.ValueWrapper", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.Inventory")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.VendorModel", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.File", "Manual")
                        .WithMany()
