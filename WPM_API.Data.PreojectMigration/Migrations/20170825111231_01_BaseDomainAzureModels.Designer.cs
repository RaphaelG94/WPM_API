...
namespace WPM_API.Data.ProjectMigration.Migrations
{
    ...
    [Migration("20170825111231_01_BaseDomainAzureModels")]
    partial class _01_BaseDomainAzureModels
    {
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.AzureCredentials", b =>
                {
                    ...
                    b.HasIndex("Customer_Id")
                        .IsUnique()
                        .HasFilter("[FK_Customer] IS NOT NULL");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Base", b =>
                {
                    ...
                    b.Property<string>("Credentials_Id")
                        .HasColumnName("FK_Credentials");
