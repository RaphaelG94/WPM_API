...
namespace WPM_API.Data.ProjectMigration.Migrations
{
    ...
    [Migration("20210921120315_298_AddBaselineFileContent")]
    partial class _298_AddBaselineFileContent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Client", b =>
                {
                    ...
                    b.Property<string>("BaseLineFile1Content");

                    b.Property<string>("BaseLineFile2");

                    b.Property<string>("BaseLineFile2Content");

                    b.Property<string>("BaseLineFile3");

                    b.Property<string>("BaseLineFile3Content");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.CustomerImage", b =>
                {
                    ...
                    b.Property<string>("DesktopFileId");
                    ...
                    b.HasIndex("DesktopFileId");

                    b.HasIndex("OEMLogoId");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.CustomerImage", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.CustomerImageStream")
                        .WithMany("Images")
                        .HasForeignKey("CustomerImageStreamId");

                    b.HasOne("Bitstream.Data.DataContext.Entities.File", "DesktopFile")
                        .WithMany()
                        .HasForeignKey("DesktopFileId");

                    b.HasOne("Bitstream.Data.DataContext.Entities.File", "OEMLogo")
                        .WithMany()
                        .HasForeignKey("OEMLogoId");
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.File", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.CustomerHardwareModel")
                        .WithMany("Drivers")
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.Image", b =>
                {
                    ...
                    b.HasOne("Bitstream.Data.DataContext.Entities.ImageStream")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Bitstream.Data.DataContext.Entities.ScriptVersion", b =>
                {
                    b.HasOne("Bitstream.Data.DataContext.Entities.AdminDeviceOption")
                        .WithMany("Versions")
